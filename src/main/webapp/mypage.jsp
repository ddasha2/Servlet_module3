...
<body>
    ...
    <div class="container shadow-lg p-5 mt-5 mb-5 bg-white rounded">
        ...
        <div class="content">
            <p><i class="bi bi-clock-fill"></i> Время: ${currentTime}</p>
            <p><i class="bi bi-folder-fill"></i> Текущий путь: ${currentPath.replace("\\", " > ")}</p>
            <p>
                <a class="badge rounded-pill bg-info text-dark" href="files?path=${URLEncoder.encode(parentPath, 'UTF-8')}">
                    <i class="bi bi-arrow-bar-up"></i> Вверх
                </a>
            </p>
